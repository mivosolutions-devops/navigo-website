  ...
  return (
    <div className=' w-full h-full pt-24 flex flex-col bg-[#F8FCFA]'>
      <button
        ...
        className='absolute top-10 items-center justify-center left-10 p-2 rounded-full bg-[#05966917] text-[#059669] hover:bg-[#059669] flex flex-row transition-all duration-200 hover:text-white'
      >
        <svg
